...
class UnitPreferencesTest {
    @Test fun missingAndMalformedValuesUseIndependentMetricDefaults() {
        val preferences = MemoryPreferences().apply { edit().putString("display_units_speed", "bad").putString("display_units_altitude", "ft").commit() }
    ...
    @Test fun writesAllSelectionsAndASecondReadRestoresThem() {
        ...
        val expected = UnitPreferences(SpeedUnit.KNOTS, AltitudeUnit.FEET, DistanceUnit.MILES, VerticalSpeedUnit.FEET_PER_MINUTE, PressureUnit.INCHES_OF_MERCURY)
    ...
    private class MemoryPreferences : SharedPreferences {
        ...
        private inner class Editor : SharedPreferences.Editor {
            ...
            private fun put(key: String, value: Any?): SharedPreferences.Editor { if (value == null) values.remove(key) else values[key] = value; return this }
        }
    }
}
